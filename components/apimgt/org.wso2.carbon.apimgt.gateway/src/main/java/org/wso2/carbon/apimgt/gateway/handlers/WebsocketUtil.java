...
public class WebsocketUtil {
	...
	public static org.apache.synapse.MessageContext getSynapseMessageContext(String tenantDomain) throws AxisFault {
...
//		}
	...
	private static org.apache.axis2.context.MessageContext createAxis2MessageContext() {
		...
		axis2MsgCtx.setConfigurationContext(
				org.wso2.carbon.inbound.endpoint.osgi.service.ServiceReferenceHolder.getInstance().getConfigurationContextService()
